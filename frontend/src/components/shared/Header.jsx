    ...
    <header className="shadow-lg sticky">
      <div className="flex justify-between items-center max-w-6xl lg:max-w-7xl mx-auto p-4">
        ...
        <ul className="flex gap-4">
          <Link to={"/"}>
            <li className="lg:inline text-slate-700 hover:underline">Home</li>
          </Link>
          <Link to={"/about"}>
            <li className="lg:inline text-slate-700 hover:underline">About</li>
          </Link>
          <Link to={"/news"}>
            <li className="lg:inline text-slate-700 hover:underline">
              New Articles
            </li>
          </Link>
        </ul>
